...
<head>
    ...
    <title>Forgot Password - Stylists</title>
...
<div id=wrapper>
    ...
    <div id="loginform">
        <p class="title">Forgot Your Password, Stylist?</p>
        ...
        <form method="POST" action="forgotpwd_stylists.php">
            <p>EMAIL</p>
            ...
            <p><a href="login_stylists.php"><span style="color: rgb(180, 0, 0)">Go Back</span></a></p>
        </form>
