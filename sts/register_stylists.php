...
<div id=wrapper>
    ...
    <div id="loginform">
        ...
        <p style="text-align: center; color: rgb(114, 118, 125);">Register as a Stylist</p>
        <form method="POST" action="signup_stylists.php">
            <p>NAME</p>
            ...
            <p>Already have an account? <a href="login_stylists.php"><span style="color: rgb(220, 0, 0)">Login</span></a></p>
        </form>
